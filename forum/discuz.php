...
<script type="text/javascript" src="$_G['style']['styleimgdir']/js/wxd_mhqh.js"></script>
...
<div id="pt" class="bm cl">
	...
	<div class="z">
<iframe width="120" height="22" frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0" scrolling="no" border="0" src="http://widget.weibo.com/relationship/followbutton.php?language=zh_cn&amp;width=110&amp;height=22&amp;uid=5051857418&amp;style=2&amp;btn=red&amp;dpc=1"></iframe>
</div>
...
<!--{if empty($gid)}-->
	<div class="wp">  
    <div class="w_htmlmh w_pb"> 
		
        <div class="wxd_gg980 mb6 wxd_1box"><!--[diy=wxd_gg001]--><div id="wxd_gg001" class="area"></div><!--[/diy]--></div>
        	
		<div class="wxd_ltym mb6 wxd_box">
        	<div class="wxd_pa5"></div>
        	<div class="wxd_ltym1">
        		<div class="wxd_ltym2">
        			<div class="wxd_ltym01">
                		<div class="wxd_ltym0101 mb6"><!--[diy=wxd_ltl01]--><div id="wxd_ltl01" class="area"></div><!--[/diy]--></div>
        			</div>
                	<div class="wxd_ltym02">
                        <div class="wxd_ltym023 wxd_pa5">
                        	<div class="wxd_tab"> <!--[diy=wxd_lt2]--><div id="wxd_lt2" class="area"></div><!--[/diy]--></div>	
                        </div>
        			</div>
            	</div>
            	<div class="wxd_ltym03">
           	 		<div  class="wxd_ltym031 wxd_pa5"><!--[diy=wxd_ltl04]--><div id="wxd_ltl04" class="area"></div><!--[/diy]--></div>
        		</div> 	
       		</div>
    	</div>
    
    	<div class="wxd_tpgd mb6 wxd_2box">
    		<a name="nav_1" id="nav_1"></a>
    		<div class="wxd_hr"></div>
   			<h2 class="wxd_bt">
				<em><a href="#">我要发布</a>/<a href="#">更多+</a></em>
				精彩图片<span>EXCITING RECMMENDED</span>
			</h2>
       	 <div class="wxd_pa5 wxd_tpgdoh "><!--[diy=wxd_tp01]--><div id="wxd_tp01" class="area"></div><!--[/diy]--></div>
		</div>
    
    	<div class="wxd_gg980 mb6 wxd_1box"><!--[diy=wxd_gg012]--><div id="wxd_gg012" class="area"></div><!--[/diy]--></div>
    </div>
	</div>
<!--{/if}-->
