var foucsbox = function (time) {
    var time = time || 3500
    , week_foucs = function (id) { return document.getElementById(id); }
    , topCon = week_foucs('divimgplay')
    , big = week_foucs('divimginfog_imgPlayer')
    , samll = week_foucs('divpageinfog_imgPlayer')
    , tip = week_foucs('ptitleg_imgPlayer')
